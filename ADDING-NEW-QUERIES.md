...
This document explains how to add new query types to **existing features** in the ReadModelQuery system. The system uses a well-known query pattern with automatic discovery and dependency injection.

> **Creating New Features?** For creating complete new vertical slices (entire feature domains), see [Creating Vertical Slices](CREATING-VERTICAL-SLICES.md)
...
- **[Creating Vertical Slices](CREATING-VERTICAL-SLICES.md)** - Complete guide for creating new feature domains from scratch
- **[System Architecture](README.md)** - Overview of the ReadModelQuery system (if available) 